...
\begin{itemize}
  ...
  \item \textbf{ApproSync (ICNP'20)}: Synchronizing state values (i.e., switch register values) directly between switch ASICs and the control plane for low latency while controlling the sending rate of state values to avoid state loss.
\end{itemize}
