...
\emph{Bridging the gap between high measurement accuracy and high resource efficiency in network measurement.}
\begin{itemize}
...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Platform: Linux (Ubuntu releases), Barefoot Tofino software development environment.
